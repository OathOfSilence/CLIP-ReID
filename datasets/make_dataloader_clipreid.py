...
def make_dataloader(cfg):
    ...
    train_set = ImageDataset(dataset.train, train_transforms, return_attributes=True)
    train_set_normal = ImageDataset(dataset.train, val_transforms, return_attributes=True)
    ...
    val_set = ImageDataset(dataset.query + dataset.gallery, val_transforms, return_attributes=True)
